...
include_once "$_VAR_DIR[p]/pgm/kr_sell/function.php";
...
<?php
include"$_VAR_DIR[p]/pgm/kr_sell/index.html";
?>
        ...
        <div id="quick">
        <ul class="quick_menu">
            <li class="on"><a class="quick_01" href="<?=$_SERVER['PHP_SELF']?>?pid=7">팔기</a></li>
