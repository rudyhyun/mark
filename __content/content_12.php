...
include_once "$_VAR_DIR[p]/pgm/kr_search/function.php";
...
<?php
include"$_VAR_DIR[p]/pgm/kr_search/index.html";
?>
        ...
        <ul class="quick_menu">
            ...
            <li class="on"><a class="quick_02" href="<?=$_SERVER['PHP_SELF']?>?pid=3&clear=true">브라우저</a></li>
