...
//게시판 기본값 설정
$_GET['table_id'] = $_GET['table_id'] ? $_GET['table_id'] : "enotice";

$ShopXX = information_shop();
$MemberXX = information_member();
$BoardControlXX = information_board();


if(!$_GET['formtype'])
{
    $_GET['formtype']=(count($BoardControlXX['isadmin'])>1&&in_array($MemberXX['id'],$BoardControlXX['isadmin']))||$MemberXX['levels']>=$_VAR_LV['administ']?"list":($BoardControlXX['formtype']?$BoardControlXX['formtype']:"list");
}
...
{
    include_once "$_VAR_DIR[p]/board/function.php";
    $_POST['formtype'] ? $_POST['formtype']() : $_GET['formtype']();
    exit;
}

// 초기화 및 초기설정
include_once "$_VAR_DIR[p]/board/board.php";
...
<body>
	...
	<div id="wrap">
        ...
        <div id="container">
            ...
            <?php include_once "$_VAR_DIR[p]/board/$_GET[formtype].php"; ?>
