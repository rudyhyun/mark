...
<body>
	...
	<div id="wrap">
        ...
        <div id="container">
            ...
            <div class="policy">
	<p>'온선데이'는 (이하 '회사'는)고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.</p>
	<p class="btmMargin">회사는 개인정보취급방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.</p>
	...
	<p class="btmMargin">회사는 회원가입, 상담, 서비스 신청 등 을 위해 아래와 같은 개인정보를 수집하고 있습니다.</p>
	 
	<ul>
		<li>ο 수집항목 : 이름 ,아이디, 생년월일, 성별, 비밀번호, 비밀번호 분실 시 질문, 비밀번호 분실 시 답, 이메일, 주소, 연락처(전화번호, 휴대전화), 외국인등록번호 또는 여권번호(외국인에 한함), 만 14세 미만인 경우 법정대리인 정보, 국적(외국인에 한함)<br>
			단, 서비스 이용 과정에서 다음과 같은 정보들이 자동으로 생성되어 저장될 수 있습니다. 
			<ul>
				<li>: 접속 IP 정보, 쿠키, 방문일시, 서비스 이용 기록, 불량 이용기록</li>
			</ul>
		</li>
		<li>ο 개인정보 수집방법 : 홈페이지(회원가입/정보수정), 서비스 이용, 전화/팩스를 통한 회원 상담,</li>
	</ul>
	 
	<h2>■ 개인정보의 수집 및 이용목적</h2>
	 
	<p>회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다.</p>
	<p class="btmMargin">회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.</p>
	 
	<ul>
		<li>ο 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산
			<ul>
				<li>: 콘텐츠 제공, 특정 맞춤 서비스 제공, 본인인증, 물품배송 및 청구서 등 발송, 구매 및 요금 결제, 요금 추심</li>
			</ul>
		</li>
		<li>ο 회원 관리 
			<ul>
				<li>: 회원제 서비스 이용에 따른 본인 확인, 개인 식별, 불량회원의 부정 이용 방지와 비인가 사용 방지 , 가입 의사 확인, 연령 확인, 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인, 불만 처리 등 민원처리, 불만고지사항 전달</li>
			</ul>
		</li>
		<li>ο 마케팅 및 광고에 활용 
			<ul>
				<li>: 신규 서비스(제품) 개발 및 맞춤서비스 제공, 통계학적 특성에 따른 서비스 제공 및 광고 게재, 이벤트 및 광고성 정보 전달, 접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계</li>
			</ul>
		</li>
	</ul>
	...
	<p class="btmMargin">원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존합니다.</p>

	<ul>
		<li>보존 항목 : 이름 , 아이디, 비밀번호, 비밀번호 분실 시 실문, 비밀번호 분실 시 답, 이메일, 주소, 연락처(전화번호, 휴대전화), 외국인등록번호 또는 여권번호(외국인에 한함), 만 14세 미만인 경우 법정대리인 정보, 부정이용 기록</li>
		<li>보존 근거 : 서비스 이용의 혼선 방지 및 사용자의 콘텐츠 불량 이용에 대한 근거자료 보관 </li>
		<li>보존 기간 : 6개월</li>
	</ul>
	...
	<p class="btmMargin">회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 파기절차 및 방법은 다음과 같습니다.</p>
	 
	 <ul>
		<li>ο 파기절차
			<ul>
				<li>회원님이 회원가입 등을 위해 입력하신 정보는 목적이 달성된 후 별도의 DB로 옮겨져(종이의 경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(보유 및 이용기간 참조) 일정 기간 저장된 후 파기되어집니다.<br> 
	...
	<p>이용자 혹은 만 14세 미만 아동의 개인정보 조회 수정을 위해서는 ‘개인정보변경’(또는 ‘회원정보수정’ 등)을 가입해지(동의철회)를 위해서는 “회원탈퇴”를 클릭 하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다. 혹은 개인정보관리책임자에게 서면, 전화 또는 이메일로 연락하시면 지체없이 조치하겠습니다.</p>
	...
	<p class="btmMargin">회사는 귀하의 정보를 수시로 저장하고 찾아내는 ‘쿠키(cookie)’ 등을 운용합니다. 쿠키란 온선데이의 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에 저장됩니다. 회사는 다음과 같은 목적을 위해 쿠키를 사용합니다.</p>
	...
	<p class="btmMargin">회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보관리책임자를 지정하고 있습니다.</p>
	 
	<p>고객서비스담당 부서 : 기획부서</p>
	<p>전화번호 : 1666-7765</p>
	<p>이메일 : help@rudystory.com</p>
	 
	<p class="btmMargin">귀하께서는 회사의 서비스를 이용하며 발생하는 모든 개인정보보호 관련 민원을 개인정보관리책임자 혹은 담당부서로 신고하실 수 있습니다. 회사는 이용자들의 신고사항에 대해 신속하게 충분한 답변을 드릴 것입니다.</p>
	 
	<p class="btmMargin">기타 개인정보침해에 대한 신고나 상담이 필요하신 경우에는 아래 기관에 문의하시기 바랍니다.</p>
