...
include_once "$_VAR_DIR[p]/pgm/kr_message/function.php";
...
<?php
include"$_VAR_DIR[p]/pgm/kr_message/index.html";
?>
        ...
        <ul class="quick_menu">
            ...
            <li class="on"><a class="quick_03" href="<?=$_SERVER['PHP_SELF']?>?pid=5">메시지</a><?=$MemberXX['message']?></li>
