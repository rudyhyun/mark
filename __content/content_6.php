...
include_once "$_VAR_DIR[p]/pgm/en_message/function.php";
...
<?php
include"$_VAR_DIR[p]/pgm/en_message/index.html";
?>
        ...
        <ul class="quick_menu">
            ...
            <li class="on"><a class="equick_03" href="<?=$_SERVER['PHP_SELF']?>?pid=6">Message</a><?=$MemberXX['message']?></li>
