...
include_once "$_VAR_DIR[p]/pgm/kr_alert/function.php";
...
<?php
include"$_VAR_DIR[p]/pgm/kr_alert/index.html";
?>
        ...
        <ul class="quick_menu">
            ...
            <li class="on"><a class="quick_04" href="<?=$_SERVER['PHP_SELF']?>?pid=8">알림</a></li>
