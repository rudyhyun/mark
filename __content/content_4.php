...
include_once "$_VAR_DIR[p]/pgm/en_brower/function.php";
...
<?php
include"$_VAR_DIR[p]/pgm/en_brower/index.html";
?>
        ...
        <ul class="quick_menu">
            ...
            <li class="on"><a class="equick_02" href="<?=$_SERVER['PHP_SELF']?>?pid=4&clear=true">Brower</a></li>
