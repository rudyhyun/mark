...
<body>
	...
	<div id="wrap">
        ...
        <div id="container">
            ...
            &#39;온선데이&#39;는 (이하 &#39;회사&#39;는)고객님의 개인정보를 중요시하며, &quot;정보통신망 이용촉진 및 정보보호&quot;에 관한 법률을 준수하고 있습니다.<br />
...
■ 수집하는 개인정보 항목<br />
<br />
회사는 회원가입, 상담, 서비스 신청 등 을 위해 아래와 같은 개인정보를 수집하고 있습니다.<br />
<br />
&omicron; 수집항목 : 이름 ,아이디, 생년월일, 성별, 비밀번호, 비밀번호 분실 시 질문, 비밀번호 분실 시 답, 이메일, 주소, 연락처(전화번호, 휴대전화), 외국인등록번호 또는 여권번호(외국인에 한함), 만 14세 미만인 경우 법정대리인 정보, 국적(외국인에 한함)<br />
단, 서비스 이용 과정에서 다음과 같은 정보들이 자동으로 생성되어 저장될 수 있습니다.<br />
: 접속 IP 정보, 쿠키, 방문일시, 서비스 이용 기록, 불량 이용기록<br />
&omicron; 개인정보 수집방법 : 홈페이지(회원가입/정보수정), 서비스 이용, 전화/팩스를 통한 회원 상담,<br />
<br />
■ 개인정보의 수집 및 이용목적<br />
<br />
...
: 콘텐츠 제공, 특정 맞춤 서비스 제공, 본인인증, 물품배송 및 청구서 등 발송, 구매 및 요금 결제, 요금 추심<br />
&omicron; 회원 관리<br />
: 회원제 서비스 이용에 따른 본인 확인, 개인 식별, 불량회원의 부정 이용 방지와 비인가 사용 방지 , 가입 의사 확인, 연령 확인, 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인, 불만 처리 등 민원처리, 불만고지사항 전달<br />
&omicron; 마케팅 및 광고에 활용<br />
: 신규 서비스(제품) 개발 및 맞춤서비스 제공, 통계학적 특성에 따른 서비스 제공 및 광고 게재, 이벤트 및 광고성 정보 전달, 접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계<br />
<br />
■ 개인정보의 보유 및 이용기간<br />
<br />
원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존합니다.<br />
<br />
보존 항목 : 이름 , 아이디, 비밀번호, 비밀번호 분실 시 실문, 비밀번호 분실 시 답, 이메일, 주소, 연락처(전화번호, 휴대전화), 외국인등록번호 또는 여권번호(외국인에 한함), 만 14세 미만인 경우 법정대리인 정보, 부정이용 기록<br />
보존 근거 : 서비스 이용의 혼선 방지 및 사용자의 콘텐츠 불량 이용에 대한 근거자료 보관<br />
보존 기간 : 6개월<br />
<br />
...
이용자 혹은 만 14세 미만 아동의 개인정보 조회 수정을 위해서는 &lsquo;개인정보변경&rsquo;(또는 &lsquo;회원정보수정&rsquo; 등)을 가입해지(동의철회)를 위해서는 &ldquo;회원탈퇴&rdquo;를 클릭 하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다. 혹은 개인정보관리책임자에게 서면, 전화 또는 이메일로 연락하시면 지체없이 조치하겠습니다.<br />
...
회사는 이용자 혹은 법정 대리인의 요청에 의해 해지 또는 삭제된 개인정보는 회사가 수집하는 개인정보의 보유 및 이용기간&rdquo;에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.<br />
<br />
■ 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항<br />
<br />
회사는 귀하의 정보를 수시로 저장하고 찾아내는 &lsquo;쿠키(cookie)&rsquo; 등을 운용합니다. 쿠키란 온선데이의 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에 저장됩니다. 회사는 다음과 같은 목적을 위해 쿠키를 사용합니다.<br />
<br />
▶ 쿠키 등 사용 목적<br />
...
고객서비스담당 부서 : 기획부서<br />
전화번호 : 1666-7765<br />
이메일 : help@rudystory.com<br />
<br />
귀하께서는 회사의 서비스를 이용하며 발생하는 모든 개인정보보호 관련 민원을 개인정보관리책임자 혹은 담당부서로 신고하실 수 있습니다. 회사는 이용자들의 신고사항에 대해 신속하게 충분한 답변을 드릴 것입니다.<br />
<br />
