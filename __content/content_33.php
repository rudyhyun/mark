...
include_once "$_VAR_DIR[p]/pgm/en_alert/function.php";
...
<?php
include"$_VAR_DIR[p]/pgm/en_alert/index.html";
?>
        ...
        <ul class="quick_menu">
            ...
            <li class="on"><a class="equick_04" href="<?=$_SERVER['PHP_SELF']?>?pid=33">Notifications</a></li>
