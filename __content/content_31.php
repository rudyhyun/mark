...
include_once "$_VAR_DIR[p]/pgm/en_sell/function.php";
...
<?php
include"$_VAR_DIR[p]/pgm/en_sell/index.html";
?>
        ...
        <div id="quick">
        <ul class="quick_menu">
            <li class="on"><a class="equick_01" href="<?=$_SERVER['PHP_SELF']?>?pid=31">Sell</a></li>
